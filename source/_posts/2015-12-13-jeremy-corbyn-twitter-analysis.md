...
category: project  
picture: "/images/jeremy-corbyn-twitter-analysis/cluster1.png"
tags:
- project
- report
---
...
<img src="{{ site.url | append: '/images/jeremy-corbyn-twitter-analysis/histogram1.png' }}" class="img-center">
...
<img src="{{ site.url | append: '/images/jeremy-corbyn-twitter-analysis/histogram2.png' }}" class="img-center">
...
<img src="{{ site.url | append: '/images/jeremy-corbyn-twitter-analysis/scatter1.png' }}" class="img-center">

After removing location based outliers, the dataset was far less dispersed.

<img src="{{ site.url | append: '/images/jeremy-corbyn-twitter-analysis/scatter2.png' }}" class="img-center">
...
<img src="{{ site.url | append: '/images/jeremy-corbyn-twitter-analysis/cluster1.png' }}" class="img-center">
<img src="{{ site.url | append: '/images/jeremy-corbyn-twitter-analysis/cluster1table1.png' }}" class="img-center">
<img src="{{ site.url | append: '/images/jeremy-corbyn-twitter-analysis/cluster1table2.png' }}" class="img-center">
...
<img src="{{ site.url | append: '/images/jeremy-corbyn-twitter-analysis/cluster1scatter1.png' }}" class="img-center">
...
<img src="{{ site.url | append: '/images/jeremy-corbyn-twitter-analysis/cluster2.png' }}" class="img-center">
<p class="text-center">Note: Icons for clusters two and three overlap</p>
<img src="{{ site.url | append: '/images/jeremy-corbyn-twitter-analysis/cluster2table1.png' }}" class="img-center">
<img src="{{ site.url | append: '/images/jeremy-corbyn-twitter-analysis/cluster2table2.png' }}" class="img-center">
...
<img src="{{ site.url | append: '/images/jeremy-corbyn-twitter-analysis/londonconstituencies.png' }}" class="img-center">
...
<img src="{{ site.url | append: '/images/jeremy-corbyn-twitter-analysis/constituencies.png' }}" class="img-center">
...
<img src="{{ site.url | append: '/images/jeremy-corbyn-twitter-analysis/cluster2scatter1.png' }}" class="img-center">
