...
The code is available [here](https://github.com/JamesFrost/robocup), and the Javadoc is available [here](https://ragnarula.github.io/robocup).
...
![Dataflow diagram of the RoboCup simulation league team](){:class="img-responsive center-block"}{:data-normal="/img/robocup/dataflow.jpg"}
